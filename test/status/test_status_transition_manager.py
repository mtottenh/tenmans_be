...
class TestStatusTransitionManager:
    ...
    @pytest.mark.asyncio
    async def test_invalid_transition_no_rule(self, transition_manager: StatusTransitionManager):
    ...
    async def test_validator_failure(self, transition_manager: StatusTransitionManager):
        ...
        with pytest.raises(TransitionError, match="Validation failed: WorkInProgressValidator"):
            await transition_manager.validate_transition(
                TaskStatus.DRAFT,
                TaskStatus.IN_PROGRESS,
                context
    ...
    @pytest.mark.asyncio
    async def test_permission_check(self, session: AsyncSession, system_user: Player, transition_manager: StatusTransitionManager):
    ...
    @pytest.mark.asyncio
    async def test_suspension_validator(self, transition_manager: StatusTransitionManager, session: AsyncSession, system_user: Player):
        ...
        with pytest.raises(TransitionError, match="Validation failed: SuspensionDurationValidator"):
            await transition_manager.validate_transition(
                TaskStatus.IN_PROGRESS,
    ...
    @pytest.mark.asyncio
    async def test_completion_validator(self, transition_manager: StatusTransitionManager):
        ...
        with pytest.raises(TransitionError, match="Validation failed: CompletionValidator"):
            await transition_manager.validate_transition(
                TaskStatus.REVIEW,
                TaskStatus.COMPLETED,
                context
    ...
    @pytest.mark.asyncio
    async def test_minimum_reason_length_validator(self, transition_manager: StatusTransitionManager):
        ...
        with pytest.raises(TransitionError, match="Validation failed: MinimumReasonLengthValidator"):
            await transition_manager.validate_transition(
                TaskStatus.ON_HOLD,
                TaskStatus.IN_PROGRESS,
                context
    ...
    @pytest.mark.asyncio
    async def test_any_status_rule(self, transition_manager: StatusTransitionManager, session: AsyncSession, system_user: Player):
