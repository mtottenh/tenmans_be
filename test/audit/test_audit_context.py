...
class TestAuditContext:
    ...
    @pytest.mark.asyncio
    async def test_simple_audit_context(
    ...
    @pytest.mark.asyncio
    async def test_nested_audit_contexts(
        self, session: AsyncSession, system_user: Player
    ):
    ...
    @pytest.mark.asyncio
    async def test_audit_event_sequence_numbering(
        self, session: AsyncSession, system_user: Player
    ):
    ...
    @pytest.mark.asyncio
    async def test_audit_context_rollback_on_error(
        self, session: AsyncSession, system_user: Player
    ):
    ...
    @pytest.mark.asyncio
    async def test_update_root_event_entity_id(
        self, session: AsyncSession, system_user: Player
    ):
    ...
    @pytest.mark.asyncio
    async def test_audit_context_with_grace_period(
        self, session: AsyncSession, system_user: Player
    ):
    ...
    @pytest.mark.asyncio
    async def test_context_depth_tracking(
        self, session: AsyncSession, system_user: Player
    ):
