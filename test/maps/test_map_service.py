...
@pytest.mark.asyncio
async def test_get_all_maps(map_service, test_maps, mock_session):
...
@pytest.mark.asyncio
async def test_get_map_by_id(map_service, test_maps, mock_session):
...
@pytest.mark.asyncio
async def test_get_map_not_found(map_service, mock_session):
...
@pytest.mark.asyncio
async def test_get_map_by_name(map_service, test_maps, mock_session):
...
@pytest.mark.asyncio
async def test_get_map_by_name_not_found(map_service, mock_session):
...
@pytest.mark.asyncio
async def test_get_active_maps(map_service, test_maps, mock_session):
...
@pytest.mark.asyncio
async def test_create_map(map_service, mock_session):
...
@pytest.mark.asyncio
async def test_update_map(map_service, test_maps, mock_session):
    ...
    updated_map = await map_service.update_map(
        map_id=target_map.id, update_data=update_data, session=mock_session
    )
...
@pytest.mark.asyncio
async def test_delete_map(map_service, test_maps, mock_session):
...
@pytest.mark.asyncio
async def test_get_maps_for_tournament(map_service, test_maps, mock_session):
...
@pytest.mark.asyncio
async def test_validate_map_pool(map_service, test_maps, mock_session):
    ...
    mock_session.execute.side_effect = [
        Mock(scalars=scalars) for scalars in mock_scalars_list
    ]
...
async def test_validate_map_pool_with_inactive_map(
    map_service, test_maps, mock_session
):
...
@pytest.mark.asyncio
async def test_get_map_statistics(map_service, test_maps, mock_session):
...
@pytest.mark.asyncio
async def test_search_maps(map_service, test_maps, mock_session):
