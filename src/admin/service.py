...
def create_admin_service(auth_svc: Optional[AuthService] = None, status_transition_svc: Optional[StatusTransitionService] = None) -> AdminService:
    """Create and configure AdminService with its dependencies"""
    auth_service = auth_svc or  create_auth_service()
    status_transition_service = status_transition_svc or create_status_transition_service()
    return AdminService(
