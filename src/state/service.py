...
class StateService:
    ...
    async def store_state(
        ...
        state = State(type=state_type, data=data.model_dump_json(), metadata=metadata)
        ...
        await self.redis.setex(key, expiry, json.dumps(state.model_dump()))
    ...
    async def extend_expiry(
        self, state_type: StateType, state_id: str, extension: timedelta
    ) -> bool:
