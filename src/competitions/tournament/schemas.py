...
from ..base_schemas import GameMode, LeagueFormat, MapSelectionMethod, TournamentType, RegistrationStatus, TournamentBase, TournamentRegistrationBase
...
class TournamentCreate(BaseModel):
    ...
    def validate_dates(self) -> Self:
        ...
        if self.allow_late_registration and self.late_registration_end:
            if self.late_registration_end >= self.scheduled_start_date:
...
class TournamentConfigUpdate(BaseModel):
    ...
    def validate_team_sizes(self) -> Self:
        ...
        if self.min_teams and self.max_teams:
